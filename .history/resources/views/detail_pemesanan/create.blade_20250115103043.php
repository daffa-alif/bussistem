...
<form action="{{ route('detail_pemesanan.store', $id_pemesanan) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md space-y-6 w-1/2 mx-auto">
    ...
    <div>
        ...
        <input type="text" name="id_kursi_bus" id="id_kursi_bus" value="{{ $id_kursi }}" readonly class="mt-1 block w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
        @error('id_kursi_bus')
