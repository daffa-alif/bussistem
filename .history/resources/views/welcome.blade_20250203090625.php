    ...
    @foreach($buses as $bus)
        <div class="flex flex-col bg-white rounded-3xl shadow-lg">
            ...
            <div class="flex px-6 pb-8 sm:px-8">
                <a href="{{ route('pemesanan.create', ['bus_id' => $bus->id_bus]) }}" class="w-full px-6 py-2.5 text-center text-white bg-black border-2 border-black rounded-full hover:bg-transparent hover:text-black text-sm">
                    Pesan Sekarang!
                </a>
            </div>
        </div>
