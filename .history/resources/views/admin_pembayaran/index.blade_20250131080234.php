                ...
                <tr class="border-b">
                    ...
                    <td class="p-3">
                        @if($pemesanan->bukti_pembayaran)
                            <a href="{{ $pemesanan->bukti_pembayaran->file_url }}" target="_blank">
                                <img src="{{ $pemesanan->bukti_pembayaran->file_url }}" alt="Bukti Pembayaran" class="w-20 h-20 object-cover rounded-lg border">
                            </a>
                        @else
                    ...
                    <!-- Confirm Button -->
                    <td class="p-3">
                        <form action="{{ route('admin.pembayaran.confirm', ['id_pemesanan' => $pemesanan->id]) }}" method="POST">
                            @csrf
                            @method('PATCH')
