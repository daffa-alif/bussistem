...
<body class="font-sans bg-gray-100 text-gray-900">
    ...
    <nav class="flex items-center justify-between bg-white shadow-md px-6 py-4">
        ...
        <!-- Search Bar -->
        <div class="flex items-center bg-gray-100 rounded-md shadow-inner px-4 py-2 w-1/3">
    ...
    <main class="flex-1 p-6 bg-gray-50">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div id="search-bar" class="search-bar">
                <span id="search-text" class="text-gray-600 font-semibold">search: bus</span>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        const phrases = ["search: bus", "search: route"];
        ...
        function toggleSearchText() {
            ...
            setTimeout(() => {
                searchText.textContent = phrases[currentPhraseIndex];
        ...
        // Start showing phrases every 3.5 seconds
        setInterval(toggleSearchText, 3500);
