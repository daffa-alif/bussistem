...
<body class="font-sans bg-gray-100 text-gray-900">
    ...
    <nav class="bg-white shadow-md">
        <div class="flex items-center justify-between px-6 py-4">
            ...
            <button 
                id="menuButton" 
                class="lg:hidden flex items-center text-gray-700 hover:text-blue-600 focus:outline-none"
                onclick="toggleMenu()"
            >
            ...
            <div id="menu" class="hidden lg:flex lg:items-center lg:space-x-6">
                ...
                <form action="{{ route('logout') }}" method="POST" class="lg:inline">
                    @csrf
                    <button type="submit" class="flex items-center text-gray-700 hover:text-red-600 hover:bg-red-100 py-2 px-4 rounded transition">
                        <i class="fas fa-sign-out-alt mr-3"></i> Logout
                    </button>
                </form>
            </div>
        ...
        <div id="mobileMenu" class="hidden lg:hidden px-6 py-4 bg-gray-50 space-y-4">
            <a href="{{ route('dashboard') }}" class="block text-gray-700 hover:text-blue-600 hover:bg-blue-100 py-2 px-4 rounded transition">
                <i class="fas fa-tachometer-alt mr-3"></i> Dashboard
            </a>
            <a href="{{ route('pemesanan.index') }}" class="block text-gray-700 hover:text-blue-600 hover:bg-blue-100 py-2 px-4 rounded transition">
                <i class="fas fa-shopping-cart mr-3"></i> Pemesanan
            </a>
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="w-full text-left text-gray-700 hover:text-red-600 hover:bg-red-100 py-2 px-4 rounded transition">
                    <i class="fas fa-sign-out-alt mr-3"></i> Logout
                </button>
            </form>
        </div>
