        ...
        <div class="flex flex-1">
            ...
            <div class="bg-white shadow-md rounded-lg w-64 p-6 mt-4 ml-4">
                <ul class="space-y-4">
                    ...
                    <li><a href="{{route(admin_pembayaran.index)}}" class="flex items-center text-gray-700 hover:text-blue-600 hover:bg-blue-100 py-2 px-4 rounded transition">
                        <i class="fas fa-layer-group mr-3"></i>konfirmasi pembayaran</a>
                    </li>
                    <!-- New Bus Kelas Link -->
                </ul>
