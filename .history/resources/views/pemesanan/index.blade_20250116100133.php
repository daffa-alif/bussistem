            ...
            <div class="border rounded-lg shadow p-4">
                ...
                <div class="mt-4">
                    @if ($item->status !== 'cancelled' && $item->status !== 'confirmed')
                        <!-- Bayar Button -->
                        <form action="{{ route('bayar.update', $item->id_pemesanan) }}" method="POST">
                            @csrf
                            <button type="submit" class="text-blue-500">Bayar</button>
                        </form>
                    @elseif ($item->status === 'confirmed')
                        ...
                        <div class="card mt-2">
                            ...
                            <input type="file" disabled class="border p-2 w-full" />
