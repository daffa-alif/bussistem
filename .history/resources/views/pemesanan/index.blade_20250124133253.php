            ...
            <div class="border rounded-lg shadow p-4">
                ...
                <div class="mt-4">
                    @if ($item->status === 'pending')
                        ...
                        <script>
                            const deadline = new Date("{{ $item->tanggal_pemesanan }}").getTime() + 10 * 60 * 1000; // 3 minutes from pemesanan
                            ...
                            function updateCountdown() {
                                ...
                                if (distance <= 0) {
                                    ...
                                    // Send AJAX request to server to update status to cancelled
                                    fetch("{{ route('pemesanan.cancel_after_timeout', ['id' => $item->id_pemesanan]) }}")
