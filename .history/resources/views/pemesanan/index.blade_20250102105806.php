...
@section('content')
    ...
    <!-- Display Link to Detail Pemesanan after successful creation -->
    @if(session('success'))
        <div class="mt-4">
            <a href="{{ route('detail_pemesanan.index', ['id_pemesanan' => session('pemesanan_id')]) }}" class="text-blue-500 hover:text-blue-700">
