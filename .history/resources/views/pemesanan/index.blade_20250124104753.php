            ...
            pemesananItems.forEach(item => {
                if (item.status === 'pending') {
                    ...
                    if (minutesRemaining > 0) {
                        const countdownElement = document.getElementById('countdown-' + item.id_pemesanan);
                        countdownElement.textContent = 'Time remaining: ' + minutesRemaining + ' minutes';
                    } else {
                        // Automatically set to cancelled if time is up (optional)
