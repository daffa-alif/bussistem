    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            countdownElements.forEach(function(element) {
                const createdAt = new Date(element.dataset.createdAt); // Date when the booking was created
                ...
                function updateCountdown() {
                    ...
                    const remainingMinutes = 15 - minutesElapsed; // Remaining minutes
                    const remainingSeconds = 60 - Math.floor((timeDiff / 1000) % 60); // Remaining seconds
