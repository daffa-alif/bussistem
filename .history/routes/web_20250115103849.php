...
Route::get('detail_pemesanan/create/{id_pemesanan}/{id_kursi}', [DetailPemesananController::class, 'create'])->name('detail_pemesanan.create');
...
Route::get('/get-available-seats/{id_jadwal}', [PemesananController::class, 'getAvailableSeats']);
