...
// Add role middleware to routes that need admin role access
Route::middleware(['auth', 'role:admin'])->group(function () {
    // Admin Routes for managing buses, routes, classes, etc.
...
// Other routes for non-admin users or for users with other roles
...
// More user-specific routes that don't need admin roles
Route::middleware(['auth'])->group(function () {
