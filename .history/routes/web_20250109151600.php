...
Route::post('/bus-kelas', [BusKelasController::class, 'create']);
Route::get('/bus-kelas', [BusKelasController::class, 'index']);
Route::delete('/bus-kelas/{id_bus}/{id_kelas}', [BusKelasController::class, 'destroy']);
