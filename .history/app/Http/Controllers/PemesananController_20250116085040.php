...
{
    $pemesanan = Pemesanan::where('status', 'cancelled')->get(); // Assuming 'cancelled' is the status for canceled bookings
    return view('pemesanan.cancelled', compact('pemesanan'));
}
