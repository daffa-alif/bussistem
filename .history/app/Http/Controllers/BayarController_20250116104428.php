...
class BayarController extends Controller
{
    ...
    ppublic function index($id_pemesanan)
    {
        // Load the Pemesanan and the related detailPemesanan
        $pemesanan = Pemesanan::with('detailPemesanan')->findOrFail($id_pemesanan);
    
        // Dump the data to see if it's loaded correctly
        dd($pemesanan->detailPemesanan);
    
        // Proceed with the calculation if data is loaded
