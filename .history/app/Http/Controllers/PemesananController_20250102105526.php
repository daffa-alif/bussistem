...
public function create()
{
    ...
    // Fetch available kursi_bus
    $kursi_bus = KursiBus::with(['bus', 'kelas'])->where('status_kursi', 'available')->get();

    // Create a new Pemesanan object to pass to the view
    $pemesanan = new Pemesanan();  // This will be used for the 'Lanjut ke Detail Pemesanan' link
    
    return view('pemesanan.create', compact('jadwal', 'kursi_bus', 'pemesanan'));
}
