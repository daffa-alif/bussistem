    ...
    public function index()
{
    ...
    foreach ($pemesanan as $item) {
        // Calculate the elapsed time from created_at and determine the remaining time
        ...
        // Remaining time for the booking to be confirmed
        $remaining_time = 15 - $time_diff;

        // Pass the remaining time as data for the countdown
        $item->remaining_time = max(0, $remaining_time); // Ensure it doesn't go negative
    }
