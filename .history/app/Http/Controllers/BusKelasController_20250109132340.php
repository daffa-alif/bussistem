...
class BusKelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'id_bus' => 'required|exists:bus,id',  // Ensure the bus exists
            'id_kelas' => 'required|exists:kelas,id'  // Ensure the kelas exists
        ]);
    ...
    {
        // Find the BusKelas record
        $busKelas = BusKelas::where('id_bus', $id_bus)->where('id_kelas', $id_kelas)->first();
