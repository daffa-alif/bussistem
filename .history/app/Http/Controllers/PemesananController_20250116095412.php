    ...
    public function index()
{
    if (auth()->user()->role === 'admin') {
        ...
        $pemesanan = Pemesanan::with(['user', 'jadwal', 'DetailPemesanan'])  // Load related details
    ...
    // Calculate total_harga for each pemesanan
    foreach ($pemesanan as $item) {
        $item->total_harga = $item->detailPemesanan->sum('total_harga');
    }
